...
const translations = {
  es: {
    ...
    'login.note': 'Acceso habilitado para roles autorizados de ConnectMES (Optimotion / Super usuario).',
  ...
  en: {
    ...
    'login.note': 'Access is enabled for authorized ConnectMES roles (Optimotion / Super usuario).',
